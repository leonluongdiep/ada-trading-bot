...
# HIER DEN CONSOLE CLEANUP FIX EINFÜGEN:
# [Kompletter Code aus dem Artifact]

# ==========================================================================================================
# 🔧 CONSOLE CLEANUP - ROBUST SINK RESET SYSTEM  
# ==========================================================================================================

cleanup_console <- function() {
  cat("🔧 Starting console cleanup...\n")
  
  # Mehrfacher sink() reset mit Error Handling
  for(i in 1:15) {
    tryCatch({
      sink()
...
tryCatch({
  ...
  cat("⚠️ Cleanup had issues, but console should still work\n")
})

cat("✅ CONSOLE RESTORED - You should see this in RStudio!\n")
