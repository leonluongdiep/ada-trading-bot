...
# -----Phase 3: Disaster Protection stop loss------
#place_sl_simple('ALGOUSDT_UMCBL', 'long', '10000', 0.300)
...
#---- take profit Tiered TP orders for ADA

place_tp_simple('VETUSDT_UMCBL', 'long', '50000', 0.281)
