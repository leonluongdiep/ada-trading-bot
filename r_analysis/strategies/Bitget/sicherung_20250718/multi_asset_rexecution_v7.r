...
# ==========================================================================================================
# 🔧 MULTI-ASSET CONFIGURATION (ZUERST DEFINIEREN!)D
# ==========================================================================================================
...
#place_sl_simple('ALGOUSDT_UMCBL', 'long', '20000', 0.2800)

# Tiered TP orders for ADA
#place_tp_simple('ADAUSDT_UMCBL', 'long', '5000', 0.750)

# Protective SL
#place_sl_simple('ADAUSDT_UMCBL', 'long', '5000', 0.7420)
...
# 2. Vollständige ALGO-Analyse:
ICP_analysis <- run_institutional_oi_analysis('ICPUSDT_UMCBL')


# 3. Schneller Dashboard-Blick:
ICP_dashboard <- quick_ICP_dashboard()
